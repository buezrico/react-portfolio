  ...
  return (
    <header className="h-[45vh] min-h-[400px] pt-20 pb-8 overflow-hidden relative">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        {/* Water bubble elements with me.png */}
        {/* Bubble 1 - 80px, top-left area */}
        <div className="absolute top-[15%] left-[10%] w-20 h-20 rounded-full opacity-40 animate-float">
          <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-white/30 shadow-lg shadow-primary/20 backdrop-blur-sm">
            <Image
              src="/images/me.png"
              alt=""
              fill
        ...
        {/* Bubble 2 - 60px, top-right area */}
        <div className="absolute top-[20%] right-[15%] w-16 h-16 rounded-full opacity-35 animate-float animation-delay-1000 hidden md:block">
          <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-white/30 shadow-lg shadow-primary/20 backdrop-blur-sm">
            <Image
              src="/images/me.png"
              alt=""
        ...
        {/* Bubble 3 - 100px, middle-left */}
        <div className="absolute top-[50%] left-[5%] w-24 h-24 rounded-full opacity-45 animate-float animation-delay-2000 hidden lg:block">
          <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-white/30 shadow-lg shadow-primary/20 backdrop-blur-sm">
            <Image
              src="/images/me.png"
              alt=""
        ...
        {/* Bubble 4 - 50px, middle-right */}
        <div className="absolute top-[35%] right-[25%] w-12 h-12 rounded-full opacity-30 animate-float animation-delay-3000 hidden md:block">
          <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-white/30 shadow-lg shadow-primary/20 backdrop-blur-sm">
            <Image
              src="/images/me.png"
              alt=""
        ...
        {/* Bubble 5 - 70px, lower-right */}
        <div className="absolute top-[65%] right-[10%] w-[70px] h-[70px] rounded-full opacity-40 animate-float animation-delay-4000">
          <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-white/30 shadow-lg shadow-primary/20 backdrop-blur-sm">
            <Image
              src="/images/me.png"
              alt=""
        ...
        {/* Bubble 6 - 90px, bottom-left */}
        <div className="absolute bottom-[20%] left-[20%] w-[90px] h-[90px] rounded-full opacity-50 animate-float animation-delay-5000 hidden lg:block">
          <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-white/30 shadow-lg shadow-primary/20 backdrop-blur-sm">
            <Image
              src="/images/me.png"
              alt=""
        ...
        {/* Bubble 7 - 40px, middle-center */}
        <div className="absolute top-[60%] left-[30%] w-10 h-10 rounded-full opacity-35 animate-float animation-delay-1500 hidden md:block">
          <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-white/30 shadow-lg shadow-primary/20 backdrop-blur-sm">
            <Image
              src="/images/me.png"
              alt=""
